        ...
        <div className="max-w-2xl mx-auto py-12 text-center">
                ...
                <div className="fixed inset-0 pointer-events-none overflow-hidden z-50">
                    {Array.from({ length: 50 }).map((_, i) => (
                        <motion.div
                            ...
                            className={`absolute w-3 h-3 rounded-full ${['bg-red-500', 'bg-blue-500', 'bg-green-500', 'bg-yellow-500', 'bg-purple-500', 'bg-pink-500', 'bg-cyan-500'][Math.floor(Math.random() * 7)]
                                }`}
                        />
                    ))}
                </div>
            ...
            >
                <Card className="p-4 text-center">
                    <p className="text-2xl font-bold text-gray-900">#F-2024-001</p>
